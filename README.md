...
#### 2️⃣ 페이지에 어떤 스타일 라이브러리 쓸 지 검토하기
...
##### 2️⃣-3️⃣. 어떻게 스타일을 병행할 건지 정리하기(theme, 변수 등) 

##### 2️⃣-4️⃣. 정리한 이유 중 기술적 이슈(ssr, 성능 비용 등)가 맞는지 개발팀과 크로스체크 하기
...
##### 2️⃣-5️⃣. 디자인팀과 어떻게 협업 하면 좋을 지 의논하기